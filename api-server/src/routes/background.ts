...
router.post("/background/run/live", async (_req, res) => {
...
router.post("/background/run/settle", async (_req, res) => {
...
router.post("/background/run/recalibrate", async (_req, res) => {
...
router.post("/background/run/biweekly-ai-update", async (req, res) => {
